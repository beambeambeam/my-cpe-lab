...
public class P02_GrilledGoose {
  ...
  private static void runTests() {
    // Test 1: x=100, boxes=[8,12,15,20] → Expected: 49
    ...
    // Test 2: x=123, boxes=[25,30,12] → Expected: 119
    int[] boxes2 = { 25, 30, 12 };
    ...
    // Test 3: x=500, boxes=[6,9,20] → Expected: 43
    int[] boxes3 = { 6, 9, 20 };
    ...
    // Test 4: Edge case - single box of 1 (all reachable)
    int[] boxes4 = { 1 };
